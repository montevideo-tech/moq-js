var moqplayer = (function () {
    ...
    (function () {
        ...
        class Parser {
            info;
            #mp4 = mp4box_allExports.createFile();
            #offset = 0;
            #samples = [];
            constructor(init) {
        ...
        mp4box_allExports.BoxParser.dOpsBox.prototype.write = function (stream) {
        ...
        class Renderer {
            ...
            #transform(frame) {
                ...
                if (this.#decoder.state !== "configured") {
                    ...
                    const buffer = new mp4box_allExports.DataStream(undefined, 0, mp4box_allExports.DataStream.BIG_ENDIAN);
                    box.write(buffer);
